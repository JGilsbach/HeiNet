...
############### SAOM Analysis for the BERGM imputation ##################
...
############## Analysis: TERGM Estimation for the BERGM imputation #############
...
#table LaTeX ready
stargazer(finalResults_TERGM_bergm_rounded_w12_and_w23, summary = FALSE, title="TERGM analysis, 1st wave imputed by BERGM",
